...
local MyLevelsGameplay = require("game_manager.states.MyLevelsGameplay")
local Playtest = require("game_manager.states.Playtest")
...
game_manager:register("MyLevelsGameplay", MyLevelsGameplay)
game_manager:register("CampaignGameplay", CampaignGameplay)
game_manager:register("Playtest", Playtest)
game_manager:register("Editor", Editor)
